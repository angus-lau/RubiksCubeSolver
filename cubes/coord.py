...
class Coord:
    ...
    def move(self, mv):
        ...
        self.twist = self.tables.tm[self.twist][mv]
        self.flip = self.tables.fm[self.flip][mv]
        self.udslice = self.tables.usm[self.udslice][mv]
        self.edge4 = self.tables.e4[self.edge4][mv]
        self.edge8 = self.tables.e8[self.edge8][mv]
        self.corner = self.tables.cm[self.corner][mv]
